...
import { z } from 'zod';
import { validateMcpConfig, McpConfig, mcpConfigSchema } from './mcp-schema';
...
export class McpConfigLoader {
     ...
     */
    public async updateServerConfig(serverName: string, config: z.infer<typeof mcpConfigSchema>['mcpServers'][string]): Promise<void> {
        if (!this.config) {
            throw new Error('Configuration not loaded');
        }
